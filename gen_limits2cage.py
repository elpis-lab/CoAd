...
def main():
    ...
    robotURDF = "robowflex_resources/panda/urdf/panda.urdf"
    scenepath = "configs/scenes/table/"

    scenefile = scenepath + "scene_table_GR.yaml"
    variationfile = scenepath + "variation_table_GR.yaml"
    queryfile = scenepath + "queries_pick_table_GR.yaml"
    ...
    nominal_object_pose = [
        ...
        robot_base_position[2]+object_size[2]/2
    ]
    ...
    prefix = f"TSRs/table_limit2/{robot_clearance}_{reachable_ws}_{round(object_dist[3], 2)}"
